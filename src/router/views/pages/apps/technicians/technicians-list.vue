...
import techniciansForm from '@components/form/techniciansForm'
...
export default {
    ...
    components: { Layout, techniciansForm },
    data () {
        return {
            dateConfig: {
                mode: 'range',
            ...
            fields: [
                ...
                { key: 'position', sortable: true, label: 'Especialidad' },
    ...
    <Layout>
        ...
        <div class="row page-title align-items-center">
            <div class="col-md-3 col-xl-6">
                <h4 class="mb-1 mt-0">Tecnicos</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mt-0 mb-1">Lista de tecnicos</h4>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div id="tickets-table_filter" class="dataTables_filter text-md-right">
                                    ...
                                    <button id="btn-new-event" class="btn btn-primary btn-sm mx-md-2" @click="showmodal = true">
                                        <i class="uil-plus mr-1"></i> Crear tecnicos
                                    </button>
                                    <b-modal
                                        v-model="showmodal"
                                        size="lg"
                                        title="Formulario tecnicos"
                                        title-class="font-18"
                                        hide-footer
                                    >
                                        <technicians-form />
